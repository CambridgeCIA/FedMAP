...
class Example:
    ...
    def _load_data_by_id(self, batch_size=64, mode="train"):
        data_file = f'{self.data_path}/client_{self.cid}_{mode}.csv'
        ...
        print(f"Client {self.cid} - Data size: {len(dataset)}, Features: {self.input_dim}")
    ...
    def train_loader(self, batch_size=64):
        ...
        train_loader = self._load_data_by_id(batch_size, "train")
        return train_loader
    
    def val_loader(self, batch_size=64):
        """Returns the validation data loader."""
        val_loader = self._load_data_by_id(batch_size, "test")
        return val_loader
    ...
    def train(self, patience=3, batch_size=64):
        ...
        return self.local_model.state_dict(), contribution
    
    def validate(self, batch_size=64, tier=1):
        """
